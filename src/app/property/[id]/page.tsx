...
type MembershipTier = "Legacy Circle" | "Heritage Club" | "Foundation Society";
...
export default function PropertyPage() {
  ...
  // Cast session user to our User type and get membership tier
  const userTier: MembershipTier = ((session.user as any).membershipTier as MembershipTier) || "Foundation Society";
